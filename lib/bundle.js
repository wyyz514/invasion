...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_constants_js__ = __webpack_require__(0);
...
class Grid {
    constructor(blockSize) {
        ...
        this.rows = Math.ceil(__WEBPACK_IMPORTED_MODULE_0__utils_constants_js__["a" /* default */].SCREEN_HEIGHT / this.blockSize);
    ...
    draw() {
        ...
        function drawRow(row, ctx) {
            for (let i = 0; i < row.length; i++) {
                ctx.strokeStyle = "red";
                ctx.strokeRect(row[i].y + gap, row[i].x + gap, size, size);
            }
        }
...
/* harmony export (immutable) */ __webpack_exports__["a"] = Invader;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_grid__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_invader__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__css_style_css__ = __webpack_require__(3);
...
canvas.height = __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* default */].SCREEN_HEIGHT;
canvas.width = __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* default */].SCREEN_WIDTH;
...
class Invasion {
    constructor() {
        this.grid = new __WEBPACK_IMPORTED_MODULE_1__app_grid__["a" /* default */](25);
    ...
    clear() {
        ctx.clearRect(0, 0, __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* default */].SCREEN_HEIGHT, __WEBPACK_IMPORTED_MODULE_0__utils_constants__["a" /* default */].SCREEN_WIDTH);
    }
...
/* harmony export (immutable) */ __webpack_exports__["default"] = Invasion;
